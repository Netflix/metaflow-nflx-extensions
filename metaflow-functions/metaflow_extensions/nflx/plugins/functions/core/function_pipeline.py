...
class FunctionPipeline(MetaflowFunction):
    ...
    def _reconstruct_functions_from_metadata(
        ...
        backend : Optional[str]
            Backend the constituent functions should use. If not provided,
            they fall back to the backend from config.
    ...
    def from_spec(
        ...
        backend : Optional[str]
            Backend to use. If not provided, uses the backend from config.
