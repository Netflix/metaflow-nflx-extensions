...
class Resolver:
    ...
    def __init__(self, conda: "metaflow_extensions.netflixext.plugins.conda.conda.Conda"):
        self._conda = conda

    def resolve(
        self,
        env_type: "metaflow_extensions.netflixext.plugins.conda.env_descr.EnvType",
        ...
        builder_envs: Optional[
            List["metaflow_extensions.netflixext.plugins.conda.env_descr.ResolvedEnvironment"]
        ] = None,
        base_env: Optional[
            "metaflow_extensions.netflixext.plugins.conda.env_descr.ResolvedEnvironment"
        ] = None,
