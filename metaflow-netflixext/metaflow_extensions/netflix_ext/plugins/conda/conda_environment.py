...
class CondaEnvironment(MetaflowEnvironment):
    ...
    def _determine_env_type_for_step(
        ...
        if env_hits > 1:
            ...
            # But just to be safe for this refactoring PR, we keep the original behavior.
            # In the prev version of this file, when two lines at
            # https://github.netflix.net/corp/mli-metaflow-custom/blob/051bb886e99f61ba1de1eb909cd31379f4d87c75/nflx-metaflow/metaflow_extensions/nflx/plugins/conda/conda_environment.py#L524
            # get both False, and line
            # L547
            # assigns env_type = EnvType.CONDA_ONLY,
            # and L566, L568 are not hit, the eventual env_type is EnvType.CONDA_ONLY.
            return EnvType.CONDA_ONLY  # Default to conda only
