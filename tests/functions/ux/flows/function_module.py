...
@avro_function
def avro_transform_string(data: str, params: Optional[FunctionParameters] = None) -> str:
...
@json_function
def json_transform_list(data: list, params: Optional[FunctionParameters] = None) -> list:
...
@json_function
def json_process_object(data: dict, params: Optional[FunctionParameters] = None) -> dict:
