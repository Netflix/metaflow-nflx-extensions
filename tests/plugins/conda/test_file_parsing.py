...
def add_environment_basic_checks(
    ...
    if expected_env_type != EnvType.CONDA_ONLY:
        conda = Conda(echo=lambda *a, **k: None, datastore_type=DEFAULT_DATASTORE)
        expected_sources.setdefault("pypi", []).extend(conda.default_pypi_sources)
...
def test_parse_only_src_yml(cli_runner, mock_resolver_add_environment):
    ...
    add_environment_basic_checks(
        ...
        EnvType.MIXED,
        {
            ...
            "pypi": ["graphing", "outlier-detector==0.0.3"],
            "npconda": [],
        },
        {},
        {},
